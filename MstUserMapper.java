...
public interface MstUserMapper {
	 ...
	 * @return 登録件数
	 */
	@Insert("INSERT INTO mst_user (user_name, password, family_name, first_name, family_name_kana, first_name_kana, gender, created_at, updated_at)" +
			"VALUES (#{userName}, #{password}, #{familyName}, #{firstName}, #{familyNameKana}, #{firstNameKana}, #{gender}, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)")
	 ...
	 * @return 更新件数
	 */
	@Update("UPDATE mst_user SET password = #{password}, updated_at = CURRENT_TIMESTAMP WHERE user_name = #{userName}")
	int updatePassword(
			@Param("userName") String userName,
			@Param("password") String password);
